            ...
            <form autocomplete="off" novalidate class="form fv-plugins-bootstrap5 fv-plugins-framework" wire:submit="guardarDocumento">
                ...
                <div class="modal-body px-5">
                    <div class="d-flex flex-column px-5 px-lg-10">
                        ...
                        <!-- Oficina que remite el documento -->
                        <div class="mb-3">
                            ...
                            <div wire:ignore>
                                <select class="form-select oficina" id="oficina" wire:model="oficina">
                                    ...
                                    @foreach($oficinas as $of)
                                        <option value="{{ $of->id_catalogo }}" data-abreviatura="{{ $of->abreviatura_catalogo }}">{{ ($of->abreviatura_catalogo ? $of->abreviatura_catalogo . ' - ' : '') . $of->descripcion_catalogo }}</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('oficina')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="row g-3">
                                    ...
                                    $isPdf = $ext === 'pdf';
                                    $isValid = $sizeBytes <= 10485760; // 10MB @endphp <div class="col-md-6 col-lg-4" wire:key="nuevo-arquivo-{{ $index }}">
...
<script>
    ...
    document.addEventListener('livewire:initialized', () => {
        ...
        select2('idAreaRemitente', 6, 'modal-documento');
    ...
    $('#modal-documento').on('hidden.bs.modal', function() {
        ...
        if ($('.idAreaRemitente').hasClass('select2-hidden-accessible')) {
            $('.idAreaRemitente').select2('destroy');
        }
