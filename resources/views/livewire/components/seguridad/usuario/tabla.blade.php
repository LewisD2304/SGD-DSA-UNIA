                ...
                <div class="d-flex flex-wrap flex-stack my-5 mx-8">
                    ...
                    <div class="d-flex my-2">
                        <button
                            ...
                            x-data @click="$dispatch('abrirModalUsuario')"
                        >
                                ...
                                >
                                    ...
                                    @forelse ($this->usuarios as $item)
                                        <tr wire:key="{{ $item->id_usuario }}">
                                            <td>{{ $contador++ }}</td>
                                            <td><div class="fw-bold text-dark">{{ $item->nombre_usuario }}</td>
                                            <!-- ROL -->
                                            ...
                                            <td class="text-center">
                                                ...
                                                <div
                                                    class="dropdown-menu dropdown-menu-end menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-6 py-4"
                                                    style="width: 180px;"
                                                    data-kt-menu="true"
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <a
                                                            ...
                                                            @click="cargando = true; cargando_opciones = true; $dispatch('abrirModalUsuario', { id_usuario: {{ $item->id_usuario }} });"
                                                            :disabled="cargando"
                                                    ...
                                                    >
                                                        <a
                                                            class="menu-link px-3"
                                                            @click="cargando = true; cargando_opciones = true; $dispatch('abrirModalEstado', { id_usuario: {{ $item->id_usuario }} });"
                                                            :disabled="cargando"
                                                            :class="{ 'active': cargando }"
                                                            onclick="event.stopPropagation();"
                                                        >
                                                    ...
                                                    >
                                                        <a
                                                            ...
                                                            @click="cargando = true; cargando_opciones = true; $dispatch('abrirModalEliminar', { id_usuario: {{ $item->id_usuario }} });"
                                                            :disabled="cargando"
