                ...
                <div class="d-flex flex-wrap flex-stack my-5 mx-8">
                    ...
                    <div class="d-flex my-2">
                        <button
                            ...
                            x-data @click="$dispatch('abrirModalRol')"
                        >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <a
                                                            ...
                                                            @click="cargando = true; cargando_opciones = true; $dispatch('abrirModalRol', { id_rol: {{ $item->id_rol }} });"
                                                            :disabled="cargando"
                                                    ...
                                                    >
                                                        <a
                                                            class="menu-link px-3"
                                                            @click="cargando = true; cargando_opciones = true; $dispatch('abrirModalEstado', { id_rol: {{ $item->id_rol }} });"
                                                            :disabled="cargando"
                                                            :class="{ 'active': cargando }"
                                                            onclick="event.stopPropagation();"
                                                        >
                                                    ...
                                                    >
                                                        <a
                                                            ...
                                                            @click="cargando = true; cargando_opciones = true; $dispatch('abrirModalEliminar', { id_rol: {{ $item->id_rol }} });"
                                                            :disabled="cargando"
