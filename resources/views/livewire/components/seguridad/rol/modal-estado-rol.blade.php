<div wire:ignore.self class="modal fade" id="modal-estado-rol" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form autocomplete="off" novalidate class="form fv-plugins-bootstrap5 fv-plugins-framework" wire:submit="cambiarEstadoRol">
                    ...
                    <div class="d-flex flex-column px-5 ">
                        ...
                        <div class="px-4 text-center fs-5">
                            ...
                            <div class="d-flex justify-content-center mt-7">
                                ...
                                <div class="px-2 text-gray-700 text-start">{{ $nombreRolEstado }}</div>
                            </div>
                        </div>
