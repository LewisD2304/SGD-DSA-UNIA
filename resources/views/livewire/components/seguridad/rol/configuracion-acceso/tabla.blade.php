            ...
            <div class="card-header">
                ...
                <div class="card-toolbar gap-2">
                    ...
                    <button
                        ...
                        @click="cargando = true; cargando_opciones = true; $dispatch('abrirModalAcceso', { menus_seleccionados: {{ $menus_seleccionados }} });"
                                    ...
                                    @forelse ($this->menusAsignados as $item)
                                        <tr wire:key="{{ $item->id_menu }}">
                                            <td>{{ $item->nombre_menu }}</td>
                                                <td>{{ formatoFechaText($item->fecha_primer_permiso) }}</td>
                                            <td class="text-center">
                                                ...
                                                >
                                                    <button
                                                        ...
                                                        x-data="{ cargando: false }"
                                                        @cargando.window="cargando = false, cargando_opciones = false"
                                                        @click="cargando = true; cargando_opciones = true; $dispatch('abrirModalPermiso', { id_menu: {{ $item->id_menu }} });"
                                                    ...
                                                    @if ($item->fecha_primer_permiso)
                                                        <button
                                                            ...
                                                            x-data="{ cargando: false }"
                                                            @cargando.window="cargando = false, cargando_opciones = false"
                                                            @click="cargando = true; cargando_opciones = true; $dispatch('abrirModalEliminarPermiso', { id_menu: {{ $item->id_menu }} });"
                                                            :disabled="cargando_opciones"
                                                            :class="{ 'active': cargando }"
                                                        >
                                                            <template x-if="!cargando">
                                                    ...
                                                    @else
                                                        <button
                                                            ...
                                                            @click="cargando = true; cargando_opciones = true; $dispatch('abrirModalEliminarMenu', { id_menu: {{ $item->id_menu }} });"
                                                            :disabled="cargando_opciones"
                                                            :class="{ 'active': cargando }"
                                                        >
                                                            <template x-if="!cargando">
