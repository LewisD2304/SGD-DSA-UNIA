<div wire:ignore.self class="modal fade" id="modal-estado-persona" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form autocomplete="off" novalidate class="form fv-plugins-bootstrap5 fv-plugins-framework" wire:submit="cambiarEstadoPersona">
                    ...
                    <div class="d-flex flex-column px-5 ">
                        ...
                        <div class="px-4 text-center fs-5">
                            <p class="text-gray-700">
                                ...
                                @elseif ($modoModal === 2)
                                    Al deshabilitar este registro, la persona no podrá ser utilizado en operaciones actuales del sistema.
                            ...
                            <div class="d-flex justify-content-center mt-7">
                                ...
                                <div class="px-2 text-gray-700 text-start">{{ $nombrePersonaEstado }}</div>
                            </div>
                        </div>
                ...
                <div class="modal-footer d-flex justify-content-center">
                    ...
                    <button
                        ...
                        wire:target="cambiarEstadoPersona"
                    >
                        <span class="indicator-label" wire:loading.remove wire:target="cambiarEstadoPersona">
                            {{ $modoModal === 1 ? 'Habilitar' : 'Deshabilitar' }}
                        </span>
                        <span class="indicator-progress" wire:loading wire:target="cambiarEstadoPersona">
                            Cargando...
                            <span>
