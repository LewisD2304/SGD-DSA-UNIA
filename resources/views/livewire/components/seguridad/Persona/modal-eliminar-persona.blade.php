<div wire:ignore.self class="modal fade" id="modal-eliminar-persona" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form autocomplete="off" class="form fv-plugins-bootstrap5 fv-plugins-framework" wire:submit="eliminarPersona">
                    ...
                    <div class="d-flex flex-column px-5 ">
                        ...
                        <div class="px-4 text-center fs-5">
                            ...
                            <div class="d-flex justify-content-center mt-7">
                                ...
                                <div class="px-2 text-gray-700 text-start">{{ $nombrePersonaEliminar }}</div>
                            </div>
                        </div>
                ...
                <div class="modal-footer d-flex justify-content-center">
                    ...
                    <button
                        ...
                        wire:target="eliminarPersona"
                    >
                        <span class="indicator-label" wire:loading.remove wire:target="eliminarPersona">
                            Eliminar
                        </span>
                        <span class="indicator-progress" wire:loading wire:target="eliminarPersona">
                            Cargando...
                            <span>
