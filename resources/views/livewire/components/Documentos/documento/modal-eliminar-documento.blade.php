<div wire:ignore.self class="modal fade" id="modal-eliminar-documento" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered mw-400px">
        <div class="modal-content">
                ...
                <div class="d-flex flex-column px-5">
                    <div class="text-center mb-5">
                        ...
                        <div class="fs-5 text-gray-800 fw-semibold">
                            ...
                            <span class="fw-bold">{{ $nombreDocumentoEliminar }}</span>?
                        </div>
            ...
            <div class="modal-footer flex-center border-0">
                ...
                >
                    <span wire:loading.remove wire:target="eliminarDocumento">
                        <i class="ki-outline ki-trash fs-3"></i>
                        Eliminar
                    </span>
                    <span wire:loading wire:target="eliminarDocumento">
                        Procesando...
